...
\begin{table}[H]
    ...
    \begin{tabular}{|l|c|c|}
        ...
        \hline
        SciPy Direct (sparse)  & 57.5457 & 0.0128 \\
        SciPy Dense Direct     & 57.5457 & 1.8100 \\
        SciPy CG (sparse)      & 57.5457 & 0.0173 \\
        PETSc (1 proc)         & 51.7557 & 0.0058 \\
        \hline
    \end{tabular}
\end{table}

All Python solvers produce identical $L_2$ norms (57.5457), confirming consistency among the different solution methods. The PETSc solver reports a different norm (51.7557) due to differences in how the grid points are counted: PETSc uses DMDA which includes boundary points in the discretization, while Python solves only for interior points. Both solutions are mathematically equivalent when accounting for this grid interpretation.
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        \hline
        $8 \times 8$     & 0.00033  & 0.00051  & 0.00039  & 0.00012 \\
        $16 \times 16$   & 0.00084  & 0.00153  & 0.00100  & 0.00014 \\
        $32 \times 32$   & 0.00339  & 0.04174  & 0.00240  & 0.00052 \\
        $64 \times 64$   & 0.01485  & 1.81021  & 0.00890  & 0.00335 \\
        $128 \times 128$ & 0.07502  & 99.087   & 0.04861  & 0.02602 \\
        $256 \times 256$ & 0.43750  & ---      & 0.35702  & 0.20732 \\
        $512 \times 512$ & 3.03098  & ---      & 3.23241  & 2.17592 \\
        \hline
    \end{tabular}
\end{table}
...
\textbf{Observations:}
\begin{itemize}
    \item The solver achieves a speedup of $10.15\times$ with 16 processes, corresponding to 63.4\% parallel efficiency.
    ...
    \begin{itemize}
        ...
        \item Increased number of CG iterations with domain decomposition
...
\begin{figure}[H]
    ...
    \caption{Strong scaling results: (left) Speedup vs. number of processes on log-log scale, (right) Parallel efficiency vs. number of processes.}
    \label{fig:scaling}
\end{figure}
